...
public class AmazonSES {
    ...
    final String HTMLBODY = "<h1>Please verify your email address</h1>"
            ...
            + "<a href='http://ec2-63-182-150-7.eu-central-1.compute.amazonaws.com:8088/verification-service/email-verification.html?token=$tokenValue'>"
    ...
    final String TEXTBODY = "Please verify your email address. "
            ...
            + " http://ec2-63-182-150-7.eu-central-1.compute.amazonaws.com:8088/verification-service/email-verification.html?token=$tokenValue"
            + " Thank you! And we are pleased to welcome you!";
    ...
    final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
            ...
            + "<a href='http://ec2-63-182-150-7.eu-central-1.compute.amazonaws.com:8088/verification-service/password-reset.html?token=$tokenValue'>"
    ...
    final String PASSWORD_RESET_TEXTBODY = "A request to reset your password "
            ...
            + " http://ec2-63-182-150-7.eu-central-1.compute.amazonaws.com:8088/verification-service/password-reset.html?token=$tokenValue"
            + " Thank you!";
